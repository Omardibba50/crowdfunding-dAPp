...
export declare namespace HopMessage {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<HopMessage>) => HopMessage;
}
...
export declare namespace StopMessage {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<StopMessage>) => StopMessage;
}
...
export declare namespace Reservation {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<Reservation>) => Reservation;
}
...
export declare namespace Limit {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<Limit>) => Limit;
}
...
export declare namespace ReservationVoucher {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<ReservationVoucher>) => ReservationVoucher;
}
